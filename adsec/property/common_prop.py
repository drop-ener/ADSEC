...
from adsec.utils.utils import sepline, get_task_type, handle_prop_suffix
from dflow.python import upload_packages

from adsec.calculator.calculator import make_calculator
from adsec.property.BulkStatic import BulkStatic
from adsec.property.BulkRelaxtion import BulkRelaxtion
from adsec.property.SlabRelaxtion import SlabRelaxtion
from adsec.property.SlabStatic import SlabStatic
from adsec.property.AdSlabRelaxtion import AdSlabRelaxtion
from adsec.property.AdSlabStatic import AdSlabStatic
from adsec.property.Step1AdSlabRelaxtion import Step1AdSlabRelaxtion
from adsec.property.Step2AdSlabRelaxtion import Step2AdSlabRelaxtion
from adsec.property.TransitionState import TransitionState
from adsec.property.TsStatic import TsStatic
from adsec.property.Frequency import Frequency
...
def make_property_instance(parameters, inter_param):
    ...
    if prop_type == "bulk_relax":
        return BulkRelaxtion(parameters, inter_param)
    elif prop_type == "bulk_sp":
        return BulkStatic(parameters, inter_param)
    elif prop_type == "slab_relax":
        return SlabRelaxtion(parameters, inter_param)
    elif prop_type == "slab_sp":
        return SlabStatic(parameters, inter_param)
    elif prop_type == "adslab_relax":
        return AdSlabRelaxtion(parameters, inter_param)
    elif prop_type == "adslab_relax_1":
        return Step1AdSlabRelaxtion(parameters, inter_param)
    elif prop_type == "adslab_relax_2":
        return Step2AdSlabRelaxtion(parameters, inter_param)
    elif prop_type == "adslab_sp":
        return AdSlabStatic(parameters, inter_param)
    elif prop_type == "ts_static":
        return TsStatic(parameters, inter_param)
    elif prop_type == "neb":
        return TransitionState(parameters, inter_param)
    elif prop_type == "frequency":
        return Frequency(parameters,inter_param)
    else:
