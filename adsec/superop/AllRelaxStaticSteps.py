...
class AllRelaxStaticSteps(Steps):
    def __init__(
        self,
        name: str,
        make_op: Type[OP],
        ...
        self._keys = ["bulk-relaxtion-step", "bulk-static-step", "slab-relaxtion-step","slab-static-step","adslab-relaxtion-step","adslab-static-step"]
        self.step_keys = {}
